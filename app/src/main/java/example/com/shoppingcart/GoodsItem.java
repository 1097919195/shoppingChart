...
public class GoodsItem {
    ...
    private static String[][] Dishname={{"包心菜","花菜","玉米","黄花菜","空心菜","兰花菜","藕片","青菜","生菜","西红柿","香菜","玉米"},
                                            {"鹌鹑蛋","包心鱼丸","大虾","关东大鱼板","黑毛肚","鸡腿肉","螺丝肉","牛肉卷","熟牛肉","香菇脆",
                                            "鸭肠","肘花卷"},
                                            {"鸡蛋干","香干","油面筋","油豆腐","日本豆腐","千张","豆腐结","腐竹"},
                                            {"不辣","微辣","中辣","特辣","花椒油","辣椒油","醋"},{"年糕片","白圈粉","黑圈粉","方便面","龙口粉丝","土豆粉",
                                             "油条","宽粉"},{"雪花啤酒","雪碧","可乐","王老吉"}};
    private static double[][] Disprice={{2.5,3,1.5,2,2,3,3.5,1,1,2,3.5,5},{5,3,10,3,8,6,5,10,15,5,7,7},{5,3,3,4,6,2,2,3},{0,0,0,0,0,0,0},
                                            {3,2.5,2.5,2,3,3,2,4},{3.5,4,4,4}};
